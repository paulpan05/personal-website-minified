...
export default function MoreAboutMe() {
  ...
  return (
    <section className="profile" id="contact" aria-labelledby="profile-heading">
      <h2 id="profile-heading"><span aria-hidden="true" className="prompt">$ </span>More About Me</h2>
