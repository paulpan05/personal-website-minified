...
*Process note: this essay was produced with AI assistance. The AI surfaced candidate sources; the author directed which sources to admit, set the methodology, and reviewed the synthesis. All figures are dated and linked so readers can check them.*
